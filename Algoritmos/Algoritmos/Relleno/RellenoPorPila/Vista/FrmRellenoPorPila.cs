...
using GeometriaComputacional.Relleno.RellenoPorPila.Controlador;
using GeometriaComputacional.Relleno.RellenoPorPila.Modelo;

namespace GeometriaComputacional
{
    public partial class FrmRellenoPorPila : Form
    {
        private readonly RellenoPorPilaController controlador = new();
        ...
        private const int COLS = RellenoPorPilaController.COLS;
        ...
        private void PnlContenedor_MouseClick(object? sender, MouseEventArgs e)
        {
            ...
            if (matriz[row, col] != RellenoPorPilaController.VACIA) return;
            semX = col; semY = row;
