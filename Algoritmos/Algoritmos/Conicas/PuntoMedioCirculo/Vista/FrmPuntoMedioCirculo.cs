...
using GeometriaComputacional.Conicas.PuntoMedioCirculo.Controlador;
...
namespace GeometriaComputacional
{
    ...
    {
        private readonly PuntoMedioCirculoController controlador = new();
        ...
        private ResultadoPuntoMedioCirculo? resultado;
        ...
        private void PnlContenedor_MouseDown(object? sender, MouseEventArgs e)
        {
            ...
            {
                PointF c = PantallaACartesiano(e.Location);
                bool cercaCentro = EstaProximo(c.X, c.Y, xCentro.Value, yCentro!.Value);
                bool cercaHandle = EstaProximo(c.X, c.Y, xCentro.Value + radio.Value, yCentro.Value);
        ...
        private void ActualizarResumen()
        {
            ...
            lblResultadoKPasos.Text = resultado.Pasos.Count.ToString();
        }
        ...
        private void LlenarTabla()
        {
            ...
            for (int i = 0; i < cantidad; i++)
            {
                ...
                dataGridView1.Rows.Add(paso.X, paso.Y, paso.P, paso.SimetriasTexto);
            }
        }
        ...
        private void DibujarLeyenda(Graphics g)
        {
            ...
            DibujarItemLeyenda(g, caja.X + 214, caja.Y + 34, Color.FromArgb(220, 38, 38), "Pixel");
        }
