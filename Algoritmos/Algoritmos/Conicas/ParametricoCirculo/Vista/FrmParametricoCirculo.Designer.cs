...
{
    partial class FrmParametricoCirculo
    {
        ...
        private void InitializeComponent()
        {
            ...
            colAngulo = new DataGridViewTextBoxColumn();
            colPuntoGenerado = new DataGridViewTextBoxColumn();
            btnPaso = new Button();
            ...
            lblTitulo.Size = new Size(356, 50);
            lblTitulo.TabIndex = 0;
            lblTitulo.Text = "Circunferencia parametrica";
            // 
            // lblSubtitulo
            // 
            ...
            lblSubtitulo.Size = new Size(390, 23);
            lblSubtitulo.TabIndex = 1;
            lblSubtitulo.Text = "Conicas: x = xc + r cos(t), y = yc + r sen(t).";
            // 
            // pnlEntrada
            // 
            ...
            lblTabla.Size = new Size(150, 25);
            lblTabla.TabIndex = 10;
            lblTabla.Text = "Angulos y puntos";
            // 
            // dataGridView1
            // 
            ...
            dataGridView1.Columns.AddRange(new DataGridViewColumn[] { colX, colY, colAngulo, colPuntoGenerado });
            ...
            // colAngulo
            // 
            colAngulo.HeaderText = "angulo";
            colAngulo.MinimumWidth = 6;
            colAngulo.Name = "colAngulo";
            colAngulo.ReadOnly = true;
            colAngulo.Width = 90;
            // 
            // colPuntoGenerado
            // 
            colPuntoGenerado.HeaderText = "punto generado";
            colPuntoGenerado.MinimumWidth = 6;
            colPuntoGenerado.Name = "colPuntoGenerado";
            colPuntoGenerado.ReadOnly = true;
            colPuntoGenerado.Width = 180;
            // 
            // btnPaso
            // 
            ...
            Name = "FrmParametricoCirculo";
            Text = "Circunferencia parametrica";
        ...
        private DataGridViewTextBoxColumn colAngulo;
        private DataGridViewTextBoxColumn colPuntoGenerado;
