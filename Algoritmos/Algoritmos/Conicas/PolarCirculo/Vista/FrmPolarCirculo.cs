...
using GeometriaComputacional.Conicas.PolarCirculo.Controlador;
using GeometriaComputacional.Conicas.PolarCirculo.Modelo;

namespace GeometriaComputacional
{
    public partial class FrmPolarCirculo : Form
    {
        private readonly PolarCirculoController controlador = new();
        ...
        private ResultadoPolarCirculo? resultado;
        ...
        private void LlenarTabla()
        {
            ...
            for (int i = 0; i < cantidad; i++)
            {
                ...
                dataGridView1.Rows.Add(paso.PixelX, paso.R, paso.Theta, paso.PuntoFormateado);
            }
        }
